...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Valores.grafica'
        db.alter_column(u'app_valores', 'grafica_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Graficas'], null=True))

    def backwards(self, orm):

        # Changing field 'Valores.grafica'
        db.alter_column(u'app_valores', 'grafica_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Graficas']))
